...
Z(z[4])
Z([a,[[2,'+'],[[2,'+'],[[6],[[7],[3,'mine']],[3,'today_water']],[1,'/']],[[6],[[7],[3,'mine']],[3,'parent_brokerage_fee']]]])
Z([3,'__i0__'])
Z([3,'item'])
Z([[7],[3,'team_list']])
Z(z[3])
...
Z([3,'汇款人：'])
Z(z[31])
Z([a,[[2,'?:'],[[6],[[6],[[7],[3,'item']],[3,'$orig']],[3,'remitter']],[[2,'+'],[1,'*'],[[6],[[7],[3,'item']],[3,'g0']]],[1,'']]])
Z(z[11])
Z(z[12])
Z([3,'银行卡号：'])
Z(z[31])
...
_(l9E,a0E)
_(o8E,l9E)
var tAF=_mz(z,'label',['class',38,'style',1],[],e,s,gg)
var eBF=_oz(z,40,e,s,gg)
_(tAF,eBF)
_(o8E,tAF)
_(eJE,o8E)
var bCF=_mz(z,'view',['class',41,'style',1],[],e,s,gg)
var oDF=_n('label')
_rz(z,oDF,'class',43,e,s,gg)
var xEF=_oz(z,44,e,s,gg)
_(oDF,xEF)
_(bCF,oDF)
var oFF=_mz(z,'view',['class',45,'style',1],[],e,s,gg)
var fGF=_v()
_(oFF,fGF)
var cHF=function(oJF,hIF,cKF,gg){
var lMF=_mz(z,'view',['class',50,'style',1],[],oJF,hIF,gg)
var aNF=_mz(z,'image',['bindtap',52,'data-event-opts',1,'src',2,'style',3],[],oJF,hIF,gg)
_(lMF,aNF)
_(cKF,lMF)
return cKF
}
fGF.wxXCkey=2
_2z(z,49,cHF,e,s,gg,fGF,'item','index','')
var tOF=_mz(z,'view',['bindtap',56,'class',1,'data-event-opts',2,'style',3],[],e,s,gg)
var ePF=_mz(z,'image',['src',60,'style',1],[],e,s,gg)
_(tOF,ePF)
var bQF=_mz(z,'label',['class',62,'style',1],[],e,s,gg)
var oRF=_oz(z,64,e,s,gg)
_(bQF,oRF)
_(tOF,bQF)
_(oFF,tOF)
_(bCF,oFF)
_(eJE,bCF)
_(tIE,eJE)
var xSF=_mz(z,'button',['bindtap',65,'class',1,'data-event-opts',2],[],e,s,gg)
...
var c3P=_n('view')
_rz(z,c3P,'class',11,bUP,eTP,gg)
var t7P=_n('label')
_rz(z,t7P,'class',12,bUP,eTP,gg)
var e8P=_oz(z,13,bUP,eTP,gg)
_(t7P,e8P)
_(c3P,t7P)
var o4P=_v()
_(c3P,o4P)
if(_oz(z,14,bUP,eTP,gg)){o4P.wxVkey=1
var b9P=_n('label')
_rz(z,b9P,'class',15,bUP,eTP,gg)
var o0P=_oz(z,16,bUP,eTP,gg)
_(b9P,o0P)
_(o4P,b9P)
}
else{o4P.wxVkey=2
var xAQ=_n('label')
_rz(z,xAQ,'class',17,bUP,eTP,gg)
var oBQ=_oz(z,18,bUP,eTP,gg)
_(xAQ,oBQ)
_(o4P,xAQ)
}
var l5P=_v()
_(c3P,l5P)
if(_oz(z,19,bUP,eTP,gg)){l5P.wxVkey=1
var fCQ=_mz(z,'navigator',['class',20,'url',1],[],bUP,eTP,gg)
var cDQ=_oz(z,22,bUP,eTP,gg)
_(fCQ,cDQ)
_(l5P,fCQ)
}
var a6P=_v()
_(c3P,a6P)
if(_oz(z,23,bUP,eTP,gg)){a6P.wxVkey=1
var hEQ=_mz(z,'label',['bindtap',24,'class',1,'data-event-opts',2],[],bUP,eTP,gg)
var oFQ=_oz(z,27,bUP,eTP,gg)
_(hEQ,oFQ)
_(a6P,hEQ)
}
o4P.wxXCkey=1
...
_(h1P,c3P)
var cGQ=_n('view')
_rz(z,cGQ,'class',28,bUP,eTP,gg)
var oHQ=_n('label')
_rz(z,oHQ,'class',29,bUP,eTP,gg)
var lIQ=_oz(z,30,bUP,eTP,gg)
_(oHQ,lIQ)
_(cGQ,oHQ)
var aJQ=_n('label')
_rz(z,aJQ,'class',31,bUP,eTP,gg)
var tKQ=_oz(z,32,bUP,eTP,gg)
_(aJQ,tKQ)
_(cGQ,aJQ)
_(h1P,cGQ)
var eLQ=_n('view')
_rz(z,eLQ,'class',33,bUP,eTP,gg)
var bMQ=_n('label')
_rz(z,bMQ,'class',34,bUP,eTP,gg)
var oNQ=_oz(z,35,bUP,eTP,gg)
_(bMQ,oNQ)
_(eLQ,bMQ)
var xOQ=_n('label')
_rz(z,xOQ,'class',36,bUP,eTP,gg)
var oPQ=_oz(z,37,bUP,eTP,gg)
_(xOQ,oPQ)
_(eLQ,xOQ)
_(h1P,eLQ)
var fQQ=_n('view')
_rz(z,fQQ,'class',38,bUP,eTP,gg)
var cRQ=_n('label')
_rz(z,cRQ,'class',39,bUP,eTP,gg)
var hSQ=_oz(z,40,bUP,eTP,gg)
_(cRQ,hSQ)
_(fQQ,cRQ)
var oTQ=_n('label')
_rz(z,oTQ,'class',41,bUP,eTP,gg)
var cUQ=_oz(z,42,bUP,eTP,gg)
_(oTQ,cUQ)
_(fQQ,oTQ)
_(h1P,fQQ)
var oVQ=_n('view')
_rz(z,oVQ,'class',43,bUP,eTP,gg)
var lWQ=_n('label')
_rz(z,lWQ,'class',44,bUP,eTP,gg)
var aXQ=_oz(z,45,bUP,eTP,gg)
_(lWQ,aXQ)
_(oVQ,lWQ)
var tYQ=_n('label')
_rz(z,tYQ,'class',46,bUP,eTP,gg)
var eZQ=_oz(z,47,bUP,eTP,gg)
_(tYQ,eZQ)
_(oVQ,tYQ)
_(h1P,oVQ)
var o2P=_v()
_(h1P,o2P)
if(_oz(z,48,bUP,eTP,gg)){o2P.wxVkey=1
var b1Q=_n('view')
_rz(z,b1Q,'class',49,bUP,eTP,gg)
var o2Q=_n('label')
_rz(z,o2Q,'class',50,bUP,eTP,gg)
var x3Q=_oz(z,51,bUP,eTP,gg)
_(o2Q,x3Q)
_(b1Q,o2Q)
var o4Q=_n('label')
_rz(z,o4Q,'class',52,bUP,eTP,gg)
var f5Q=_oz(z,53,bUP,eTP,gg)
_(o4Q,f5Q)
_(b1Q,o4Q)
_(o2P,b1Q)
}
...
var c6Q=_mz(z,'view',['class',54,'style',1],[],e,s,gg)
var h7Q=_oz(z,56,e,s,gg)
_(c6Q,h7Q)
_(lQP,c6Q)
_(oPP,lQP)
_(cOP,oPP)
