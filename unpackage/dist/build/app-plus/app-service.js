...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/my/my"],{"0687":function(t,e,n){"use strict";n.r(e);var o=n("5faf"),a=n.n(o);for(var s in o)"default"!==s&&function(t){n.d(e,t,function(){return o[t]})}(s);e["default"]=a.a},1959:function(t,e,n){"use strict";n.r(e);var o=n("618f"),a=n("0687");for(var s in a)"default"!==s&&function(t){n.d(e,t,function(){return a[t]})}(s);n("6432");var c=n("2877"),u=Object(c["a"])(a["default"],o["a"],o["b"],!1,null,null,null);e["default"]=u.exports},2658:function(t,e,n){},"5faf":function(t,e,n){"use strict";(function(t,n){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var o={data:function(){return{userInfo:{},message:0}},onShow:function(){var e=this,n=this.getGlobalAccessToken();t.request({url:this.serverUrl+"message-count",header:{Authorization:n,Accept:"application/json"},method:"GET",success:function(t){e.message=t.data.data}})},onLoad:function(){var e=this,n=this.getGlobalAccessToken();null!=n&&t.request({url:this.serverUrl+"user-info",header:{Authorization:n,Accept:"application/json"},method:"GET",success:function(n){200==n.data.code?e.userInfo=n.data.data:429==n.data.code?t.showToast({title:n.data.message,image:"../../static/icons/warning.png"}):t.showModal({title:"未登录",content:"您未登录，需要登录后才能继续",showCancel:!1,success:function(e){e.confirm&&t.reLaunch({url:"../registLogin/registLogin"})}})}})},methods:{exit:function(){var e=this;t.showModal({title:"注销",content:"确定退出登录",showCancel:!1,success:function(n){n.confirm&&(e.removeGlobalAccessToken(),t.reLaunch({url:"../registLogin/registLogin"}))}})},copy:function(e){t.setClipboardData({data:e,success:function(){console.log(n("success"," at pages/my/my.vue:191"))}})},toMessage:function(){t.navigateTo({url:"../my/myMessage"})}}};e.default=o}).call(this,n("6e42")["default"],n("0de9")["default"])},"618f":function(t,e,n){"use strict";var o=function(){var t=this,e=t.$createElement;t._self._c},a=[];n.d(e,"a",function(){return o}),n.d(e,"b",function(){return a})},6432:function(t,e,n){"use strict";var o=n("2658"),a=n.n(o);a.a},8021:function(t,e,n){"use strict";(function(t){n("d058"),n("921b");o(n("66fd"));var e=o(n("1959"));function o(t){return t&&t.__esModule?t:{default:t}}t(e.default)}).call(this,n("6e42")["createPage"])}},[["8021","common/runtime","common/vendor"]]]);
});
