...
var x=['./pages/content/content.wxml','./pages/index/index.wxml','./pages/registLogin/registLogin.wxml','./pages/search/search.wxml'];d_[x[0]]={}
...
_(hG,oH)
_(cF,hG)
var cI=_mz(z,'label',['class',6,'style',1],[],e,s,gg)
...
var tM=_n('image')
_rz(z,tM,'src',12,e,s,gg)
_(aL,tM)
_(lK,aL)
var eN=_mz(z,'label',['class',13,'style',1],[],e,s,gg)
...
var oR=_n('image')
_rz(z,oR,'src',19,e,s,gg)
_(xQ,oR)
_(oP,xQ)
var fS=_mz(z,'label',['class',20,'style',1],[],e,s,gg)
...
var cW=_n('image')
_rz(z,cW,'src',26,e,s,gg)
_(oV,cW)
_(hU,oV)
var oX=_mz(z,'label',['class',27,'style',1],[],e,s,gg)
...
_(e2,x5)
_(t1,e2)
var f7=_mz(z,'form',['bindsubmit',6,'data-event-opts',1],[],e,s,gg)
var c8=_n('view')
_rz(z,c8,'class',8,e,s,gg)
var h9=_mz(z,'input',['name',9,'placeholder',1,'placeholderClass',2,'type',3,'value',4],[],e,s,gg)
_(c8,h9)
_(f7,c8)
var o0=_n('view')
_rz(z,o0,'class',14,e,s,gg)
var cAB=_mz(z,'input',['name',15,'placeholder',1,'placeholderClass',2,'type',3,'value',4],[],e,s,gg)
_(o0,cAB)
var oBB=_n('label')
...
_(o0,oBB)
_(f7,o0)
var aDB=_mz(z,'button',['class',22,'formType',1],[],e,s,gg)
...
var css_id;
var info = info || {};
var _C= [[[2,1],],[".",[1],"pages{ background-color: #999999; }\n",],];
